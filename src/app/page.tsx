  ...
  return (
    <div className="p-8 bg-slate-50 dark:bg-slate-900 dark:text-slate-100 text-slate-900 h-screen flex flex-col items-center text-center " >
      <div className="max-w-2xl">
        ...
        <button className="bg-sky-500 px-4 dark:bg-sky-400 dark:text-sky-900 text-white py-2 rounded-md font-medium mt-4 enabled:hover:bg-sky-600 disabled:opacity-60 disabled:cursor-not-allowed">
          Sign in
        </button>
      </div>
    </div>
